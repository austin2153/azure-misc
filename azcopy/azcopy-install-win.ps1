...
Get-ChildItem ./AzCopy/*/azcopy.exe | Move-Item -Destination "C:\Users\CGRATER\AzCopy\AzCopy.exe"
...
[System.Environment]::SetEnvironmentVariable("PATH", $userenv + ";C:\Users\CGRATER\AzCopy", "User")